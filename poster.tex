...
Here, 
  ...
  \headerbox{Acknowledgement}{name=ack, column=2, below=conclusion}{
    \noindent
    The n-gram model used for comparison was from: {\textit{Hindle, Abram, et al.} "On the naturalness of software." \texttt{Software Engineering (ICSE), 2012 34th International Conference on. IEEE, 2012}}\\
